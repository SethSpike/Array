...
public class Encounter
{
    ...
    int[] orc = {3,5,4,8,6};
    int sum1 = 0;
    foreach (int item in orc) {
        sum1 += item;
        }
    Console.WriteLine("Golem skill rating is: {0}",sum1);
    ...
    mob2.Strength();
    mob2.Speed();
    int[] fairy = {4,2,10,2,8};
    int sum2 = 0;
    foreach (int item in fairy) {
        sum2 += item;
        }
    Console.WriteLine("Golem skill rating is: {0}",sum2);
    ...
    mob3.Strength();
    mob3.Speed();
    int[] golem = {2,10,1,10,2};
    int sum3 = 0;
    foreach (int item in golem) {
        sum3 += item;
        }
    Console.WriteLine("Golem skill rating is: {0}",sum3);
    }
}